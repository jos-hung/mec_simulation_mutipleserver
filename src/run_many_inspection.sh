...
../.venv/bin/python3 trainer.py --n_users 15 --lamd 1 --docker_min_max 1 5 --duration 1500 --output_file output_file --experiment_type 0 --LGOBAL_SEED 45
...
sleep 50
source clearqueue.sh
../.venv/bin/python3 trainer.py --n_users 15 --lamd 1 --docker_min_max 1 5 --duration 1500 --output_file output_file --experiment_type 1 --LGOBAL_SEED 45
...
sleep 100
source clearqueue.sh
../.venv/bin/python3 trainer.py --n_users 15 --lamd 1 --docker_min_max 1 5 --duration 1500 --output_file output_file --experiment_type 4 --LGOBAL_SEED 45
